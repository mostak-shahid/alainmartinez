...
function mosacademy_enqueue_scripts() {
	...
	if ($mosacademy_options['basic-styling-stylesheet']) {
		wp_register_style( $mosacademy_options['basic-styling-stylesheet'], get_template_directory_uri() .  '/css/'.$mosacademy_options['basic-styling-stylesheet'].'.css', array('main.min'));
		wp_enqueue_style( $mosacademy_options['basic-styling-stylesheet'] );		
	}
