				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div class="container">
						<?php get_template_part( 'content', 'page' ) ?>
							...
							<?php 
							$gallery_images = get_post_meta( get_the_ID(), '_mosacademy_gallery_images', true );					
							$layout = ( get_post_meta( get_the_ID(), '_mosacademy_gallery_layout', true ) ) ? get_post_meta( get_the_ID(), '_mosacademy_gallery_layout', true ) : '6';
							$large_image_size =  get_post_meta( get_the_ID(), '_mosacademy_large_image_size', true );
							$image_width =  get_post_meta( get_the_ID(), '_mosacademy_image_width', true );
							$image_height =  get_post_meta( get_the_ID(), '_mosacademy_image_height', true );
							$image_per_page =  get_post_meta( get_the_ID(), '_mosacademy_image_per_page', true );
							?>
