			...
			<?php if ( have_posts() ) :?>
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div class="container">
						...
						<?php 
						$image_per_page =  get_post_meta( get_the_ID(), '_mosacademy_link_image_per_page', true );
						$gallery_images = get_post_meta( get_the_ID(), '_mosacademy_link_gallery_details_group', true );
						$layout = ( get_post_meta( get_the_ID(), '_mosacademy_link_gallery_layout', true ) ) ? get_post_meta( get_the_ID(), '_mosacademy_link_gallery_layout', true ) : '6';
						
						$image_width =  get_post_meta( get_the_ID(), '_mosacademy_link_image_width', true );
						$image_height =  get_post_meta( get_the_ID(), '_mosacademy_link_image_height', true );
						?>
								...
								<?php foreach ( $gallery_images as $gallery_image ) : ?>
									<div class="col-md-6 col-lg-<?php echo $layout ?> text-center">
										<div class="img-container">
											<?php
											$attachment_id = $gallery_image['_mosacademy_link_gallery_details_image_id'];
										...
										<a class="hidden-link" href="<?php echo do_shortcode( $gallery_image['_mosacademy_link_gallery_details_url'] ) ?>">View Details</a>
										</div>
									</div>
								<?php endforeach;?>
							</div>
